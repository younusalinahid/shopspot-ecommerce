...
import {
    ...
    Calendar, Receipt, Eye,
    TrendingUp, Sparkles, User,
    Phone, Home, Navigation
} from 'lucide-react';
        ...
        <div
            ...
            <div className="py-8 px-4 sm:px-6 lg:px-8">
                <div className="container mx-auto max-w-7xl">
                    ...
                    <div className="mb-8">
                        <div
                            className="bg-gradient-to-r from-purple-600 via-purple-600 to-pink-600 rounded-2xl p-6 sm:p-8 text-white shadow-xl">
                            <div
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-6">
                                ...
                                <StatCard label="Total Spent" value={`৳${stats.totalSpent.toLocaleString()}`}
                                          icon={TrendingUp}/>
                            </div>
                        </div>
                    </div>
            ...
            <div className="p-5 space-y-5 max-h-[calc(100vh-120px)] overflow-y-auto custom-scrollbar">
                ...
                <div className="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-4">
                    <div className="flex items-center justify-between mb-3">
                        ...
                        <span
                            className={`flex items-center gap-1 text-xs font-medium px-2.5 py-1 rounded-full ${s.color}`}>
                        ...
                        <div className="space-y-2 text-sm">
                            ...
                            <div className="flex items-start gap-2">
                                ...
                                <div>
                                    ...
                                    {addr.area &&
                                        <p className="text-gray-600 dark:text-gray-400 text-sm">{addr.area}</p>}
                    ...
                    <div className="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-4">
                        ...
                        <div className="space-y-3">
                            <div className="flex justify-between items-center">
                                ...
                                <span
                                    className="text-sm font-medium text-gray-900 dark:text-white">{getDeliveryPartner()}</span>
                            </div>
                            <div className="flex justify-between items-center">
                                <span className="text-sm text-gray-600 dark:text-gray-400">Tracking Number</span>
                                <span
                                    className="text-sm font-mono font-medium text-purple-600 dark:text-purple-400">{getTrackingNumber()}</span>
                            </div>
                            <div className="flex justify-between items-center">
                ...
                <div className="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-4">
                    ...
                    <div className="space-y-2">
                        <div className="flex justify-between items-center">
                            ...
                            <span
                                className="text-sm font-medium text-gray-900 dark:text-white">Credit Card (Stripe)</span>
                        </div>
                        <div className="flex justify-between items-center">
                            <span className="text-sm text-gray-600 dark:text-gray-400">Payment Status</span>
                            <span
                                className={`text-sm font-medium ${order.status === 'PAID' || order.status === 'PROCESSING' || order.status === 'SHIPPED' || order.status === 'DELIVERED'
                ...
                <div className="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-4">
                    ...
                    <div className="space-y-2 text-sm">
                        <div className="flex justify-between">
                            ...
                            <span
                                className="text-gray-900 dark:text-white">৳{order.totalAmount?.toLocaleString()}</span>
                        </div>
                        <div className="flex justify-between">
                        ...
                        <div className="flex justify-between">
                            ...
                            <span
                                className="text-gray-900 dark:text-white">৳{Math.round(order.totalAmount * 0.07).toLocaleString()}</span>
                        </div>
                        <div
                            className="flex justify-between pt-2 border-t border-gray-200 dark:border-gray-600 font-bold">
                    ...
                    <div className="space-y-3 max-h-48 overflow-y-auto custom-scrollbar">
                        {order.items?.map(item => (
                            <div key={item.id}
                                ...
                                <div
                                    className="w-12 h-12 bg-gray-100 dark:bg-gray-700 rounded-lg overflow-hidden flex-shrink-0">
                                    {item.productImage ? (
                                        <img src={`data:image/jpeg;base64,${item.productImage}`} alt={item.productName}
...
function OrderCard({order, expanded, onToggle, onCancel, cancelling, index, onViewDetails}) {
    ...
    return (
        ...
        >
            <div className="p-6 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-750 transition-colors"
                 onClick={onToggle}>
                    ...
                    <div className="flex-1">
                        ...
                        <div className="flex items-center gap-2 mb-3">
                            {previewItems.map(item => (
                                <div key={item.id}
                                     className="w-14 h-14 bg-gray-100 dark:bg-gray-700 rounded-xl overflow-hidden flex-shrink-0">
                                    {item.productImage ? (
                                        <img src={`data:image/jpeg;base64,${item.productImage}`} alt={item.productName}
                                             className="w-full h-full object-cover"/>
                                    ) : (
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <span
                                className="text-sm text-gray-500">{order.items?.length} item{order.items?.length !== 1 && 's'}</span>
                        </div>
                    </div>
            ...
            {expanded && (
                <div className="border-t border-gray-100 dark:border-gray-700 p-6 bg-gray-50 dark:bg-gray-800/50">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                        ...
                        <QuickStat icon={Truck} label="Delivery"
                                   value={order.status === 'DELIVERED' ? 'Delivered' : 'In Transit'}/>
                        <QuickStat icon={CreditCard} label="Payment"
                                   value={order.status === 'PENDING' ? 'Pending' : 'Completed'}/>
