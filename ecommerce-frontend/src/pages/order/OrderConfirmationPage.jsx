            ...
            <div className="flex-grow py-10">
                <div className="container mx-auto px-4 max-w-3xl">
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-8 text-center mb-6">
                        ...
                        <span
                            className={`inline-block mt-3 px-3 py-1 rounded-full text-xs font-semibold ${STATUS_STYLE[order.status]}`}>
                            {order.status}
                        </span>
                    </div>
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 mb-6">
                        ...
                        <div className="space-y-3">
                            {order.items?.map(item => (
                                <div key={item.id}
                                    ...
                                    <div
                                        className="w-14 h-14 bg-gray-100 dark:bg-gray-700 rounded-lg flex-shrink-0 overflow-hidden flex items-center justify-center">
                                        {item.productImage
                        ...
                        <div
                            className="flex justify-between font-bold text-gray-900 dark:text-white pt-4 border-t border-gray-200 dark:border-gray-700 mt-2">
