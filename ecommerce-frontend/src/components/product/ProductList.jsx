...
const ProductList = () => {
    ...
    if (loading) {
        return (
            <div
                className="flex justify-center items-center min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
                <div
                    className="animate-spin rounded-full h-16 w-16 border-b-4 border-cyan-500 dark:border-cyan-400 transition-colors duration-300"></div>
            </div>
        );
    }
    ...
    return (
        <div className="dark:bg-gray-900 transition-colors duration-300">
            <div className="min-h-screen flex bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
                <div
                    className="w-80 flex-shrink-0 sticky top-0 h-screen overflow-y-auto bg-white dark:bg-gray-800 shadow-lg transition-colors duration-300">
                    <CategorySidebar categories={categories}/>
                </div>

                <div className="flex-1 flex flex-col">
                    <div
                        className="flex-grow bg-gray-50 dark:bg-gray-900 overflow-y-auto px-6 py-8 transition-colors duration-300">
                        <div className="mb-8">
