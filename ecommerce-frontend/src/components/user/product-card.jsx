...
export default function ProductCard({product, showDiscount = false}) {
    ...
    return (
        <div className="group bg-white shadow-sm hover:shadow-lg rounded-xl overflow-hidden transition-all duration-300">
            ...
            <div className="relative bg-gray-100 h-80 overflow-hidden"> {/* Changed to fixed height */}
                {imageSource && !imageError ? (
                    ...
                    <div className="w-full h-full flex justify-center items-center bg-gradient-to-br from-blue-100 to-green-100">
                ...
                {(showDiscount && hasDiscount) && (
                    <div className="top-3 right-3 absolute bg-red-500 px-2 py-1 rounded-full text-white text-xs font-semibold">
            ...
            {/* Product Details */}
            <div className="p-4">
                <h3 className="mb-2 font-semibold text-gray-800 group-hover:text-cyan-600 transition-colors line-clamp-2 min-h-[3rem]">
                    {product.name}
                </h3>
